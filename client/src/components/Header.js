    ...
    getNavElement = () => {
        ...
        return (
            <>
                ...
                <div className="links">
                    <li style={{ borderBottom: b1, display: "block", height: "2.5rem" }}><a href={`${process.env.PUBLIC_URL}/jobboard`}><span style={{ color: "white" }}>Feeds</span></a></li>
                    <li style={{ borderBottom: b2, display: "block", height: "2.5rem" }}><a href={`${process.env.PUBLIC_URL}/addnewjob`}><span style={{ color: "white" }}>Add Status</span></a></li>
